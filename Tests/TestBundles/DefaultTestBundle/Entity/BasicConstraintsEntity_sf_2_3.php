 ...
 *
 * @Assert\Callback(methods={"validateCallback"})
 * @Assert\Callback(methods={{"Fp\JsFormValidatorBundle\Tests\TestBundles\DefaultTestBundle\Validator\ExternalValidator", "validateStaticCallback"}})
 * @Assert\Callback(methods={{"Fp\JsFormValidatorBundle\Tests\TestBundles\DefaultTestBundle\Validator\ExternalValidator", "validateDirectStaticCallback"}})
 */
